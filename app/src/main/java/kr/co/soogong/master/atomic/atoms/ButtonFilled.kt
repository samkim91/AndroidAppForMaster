...
import kr.co.soogong.master.databinding.ViewButtonFilledBinding

class ButtonFilled @JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null,
    defStyle: Int = 0,
) : ConstraintLayout(context, attributeSet, defStyle), IButton {
    private val binding = ViewButtonFilledBinding.inflate(LayoutInflater.from(context), this, true)
