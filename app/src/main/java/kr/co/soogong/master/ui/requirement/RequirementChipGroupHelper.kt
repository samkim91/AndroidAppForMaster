...
object RequirementChipGroupHelper {
    operator fun invoke(
        ...
        val whole = layoutInflater.inflate(R.layout.single_chip_choice_rounded_layout, null) as Chip
        whole.text = "전체"
        ...
        status.map { item ->
            val chip =
                layoutInflater.inflate(R.layout.single_chip_choice_rounded_layout, null) as Chip
