...
object CancelEstimationActivityHelper {
    private const val EXTRA_BUNDLE_KEY = "CANCEL_ESTIMATION_BUNDLE_KEY"
    private const val EXTRA_INT_KEY = "CANCEL_ESTIMATION_EXTRA_INT_KEY"
